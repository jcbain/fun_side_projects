...
dogs_sf <- subset_map(dogs_sf, long = -97.7431 , lat = 30.2672, dist = 70000)
```
...
```{r}
ggplot() + 
  geom_sf(data = austin, colour = 'grey', fill = 'grey', alpha = 0) +
  geom_sf(data = dogs_sf, colour = 'black', alpha = .5) 
```
